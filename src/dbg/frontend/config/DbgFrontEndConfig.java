...
public class DbgFrontEndConfig
{
    ...
    public static String GunnyProductID ="26";
    
    public static Map<String, String> ATMDiscount = null;
    
    
    public static String DotaTKProductID ="27";
    //For TKmobi    
    public static String tkmobigetotp_URL="";    
    public static List<String> TKDienthoaiMobiChargeAmts = null;
    public static String TKMobiPatternValidate="";
    
    public static List<String> ZaloAppIDs = null;
    ...
    public static String AddMoreZingXuURL="";
    ...
    //For Vi Thap Phong
    public static String ThapPhongMoreXuURL="";
    public static int ThapPhongMinXu=10;
    public static int ThapPhongMaxXu=100;
    public static String ThapPhongGetBalanceURL="";
    
    //For Game Thap Phong
    
    public static String CCTalkAppID = "";
    ...
    public static boolean loadConfigs()
    {
        ...
        try
        {
            ...
            tkmobigetotp_URL = BaseDbgApiUrl + Config.getParam("dbgapi", "tkmobigetotp");
...
//            logger.info("MaxZingXu: " +  MaxZingXu);
            ...
            //Added for Gunny
            GunnyProductID = Config.getParam("gunny", "appid");
            logger.info("GunnyProductID: " + GunnyProductID);
            
            //ATM Discountpercent
            ATMDiscount = loadAtmDisCountPercents("123payatm","discountpercent",";",":");
         
            
            DotaTKProductID = Config.getParam("dotatk", "appid");
            logger.info("DotaTKProductID: " + DotaTKProductID);
...
//             
    ...
    private static void LoadTKDienthoaiMobiChargeAmts()
    {
     ...
     private static void LoadZaloAppIDs()
    {
        
        logger.info("--->Load  Zalo AppIDs :");
        ZaloAppIDs =  new ArrayList<>();        
        String strappIDs = Config.getParam("zalo", "appids");
        if(strappIDs!=null)
        {
            strappIDs = strappIDs.trim();
            String[]  parts = strappIDs.split(",");
            if(parts!=null && parts.length>0)
            {
                 for (int i = 0; i < parts.length; i++)
                 {
                     ZaloAppIDs.add(parts[i]);
                     logger.info("-->>Value :  " + parts[i]);
                 }
            }
        }
