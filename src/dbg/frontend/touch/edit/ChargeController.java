...
public class ChargeController extends DbgFrontendCore {
    ...
    private  CreateRequestDataResult r = null;
    ...
    protected void getTransID(HttpServletRequest request){
        ...
        r = client.createRequestData(request.getParameter("userid"),
...
//    }
    private void renderCaseTKDienThoaiMobi(HttpServletRequest request, TemplateDataDictionary dic, int pmcID, int appID) {
        if (appID == -1) {
            ...
            AppData _appdata = DecryptAppData(appID, r.appData);
            if (_appdata != null) {
                if (_appdata.flow == 2) {
